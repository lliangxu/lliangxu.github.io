...
His research interests include designing and building dependable techniques (theory + system), e.g., erasure coding (RS/LRC/MSR codes, etc), for AI/distributed persistent/caching(in-memory) storage systems.
